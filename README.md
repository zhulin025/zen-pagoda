...
- **自由的移动系统**：支持跳跃与在半空中的自由飞行（R键升空，Q键下降），以及**全图随机闪现**（T键）。支持**对齐视角闪现**（自动锁定宝塔中心）与**固定视角闪现**（保持当前视角不变），可在立体的宝塔内部或桥梁之间自由穿行。
- **觉醒巨人模式**：按下G键切换为巨人形态，体型翻倍并手持**大铁锤**，攻击半径与威力获得史诗级增强，一锤即可击溃大面积敌人。
